...
@Document
public class TotalWorkWeek {
    @Id
    private String id;
    private String week;            // числа недели
    private int year;               // год
    private int weekNumber;         // неделя в году
    ...
    public TotalWorkWeek(String week, int year, int weekNumber, long billCV,
    ...
    public TotalWorkWeek(String id, String week, int year, int weekNumber,
    ...
    public boolean equals(Object o) {
        ...
        TotalWorkWeek that = (TotalWorkWeek) o;
